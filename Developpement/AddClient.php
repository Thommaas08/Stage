...
<body>
  ...
  <div class="FORMAdd">
    ...
    <form enctype="multipart/form-data" class="ADDForm" action="InsertClient.php" method="post">
      <section class="bloc left">
        <label for="name">Nom</label>
        <input class="inputText" type="text" name="Nom_Clt" value="" placeholder="Nom...">

        <label for="name">Prénom</label>
        <input class="inputText" type="text" name="Prenom_Clt" value="" placeholder="Prénom...">
        ...
        <select class="select" name="ListeMenu">
          ...
          <option value="Madame">Sans Sel Ajouter</option>
        </select>
      </section>
