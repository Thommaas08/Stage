...
<?php
  ...
  <section class="bloc left">
       ...
       <ul>
         ...
         <li><h3>Produit laitier</h3> <p> <input type="radio" name="llaitage1" value="<?= $client['LundiLegume2'] ?>"> <?= $client['LundiLegume2'] ?>  <input type="radio" name="llaitage1" value="<?= $client['LundiLegume2'] ?>"> <?= $client['LundiLegume2'] ?>
           <input type="radio" name="llaitage1" value="<?= $client['LundiLegume2'] ?>"> <?= $client['LundiLegume2'] ?></p></p></li>
         <li><h3>Dessert </h3><p><input type="radio" name="ldessert" value="<?= $client['LundiDess1'] ?>"> <?= $client['LundiDess1'] ?>  <input type="radio" name="ldessert" value="<?= $client['LundiDess2'] ?>"> <?= $client['LundiDess2'] ?></p></li>
       </ul>
     ...
     <div class="FORMAddM">
       <section class="bloc right">
         ...
         <li> Produit laitier <input type="radio" name="Mlaitage" value="<?= $client['MardiLaitier1'] ?>"><?= $client['MardiLaitier1'] ?>  <input type="radio" name="Mlaitage" value="<?= $client['MardiLaitier2'] ?>"><?= $client['MardiLaitier2'] ?>
             <input type="radio" name="Mlaitage" value="<?= $client['MardiLaitier3'] ?>"><?= $client['MardiLaitier3'] ?></li></li>
         <li>Dessert <input type="radio" name="Mdessert" value="<?= $client['MardiDess1'] ?>"><?= $client['MardiDess1'] ?>  <input type="radio" name="Mdessert" value="<?= $client['MardiDess2'] ?>"><?= $client['MardiDess2'] ?></li>
       </section>
     </div><div class="FORMAddM">
       <section class="bloc left">
         <h1>Mercredi</h1>
         ...
         <li> Produit laitier <input type="radio" name="Merlaitage" value="<?= $client['MercrediLaitier1'] ?>"><?= $client['MercrediLaitier1'] ?> <input type="radio" name="Merlaitage" value="<?= $client['MercrediLaitier2'] ?>"><?= $client['MercrediLaitier2'] ?>
            <input type="radio" name="Merlaitage" value="<?= $client['MercrediLaitier3'] ?>"><?= $client['MercrediLaitier3'] ?></li>
         <li>Dessert <input type="radio" name="Merdessert" value="<?= $client['MercrediDess1'] ?>"><?= $client['MercrediDess1'] ?>  <input type="radio" name="Merdessert" value="<?= $client['MercrediDess2'] ?>"><?= $client['MercrediDess2'] ?></li>
       </section>
     </div><div class="FORMAddM">
       <section class="bloc left">
         <h1>Jeudi</h1>
...
<?php } elseif ($_GET['typemenu']== 3) {?>
  <section class="bloc left">
       ...
       <ul>
         ...
         <li><h3>Dessert </h3><p><input type="radio" name="ldessert" value="<?= $client['LundiDess1'] ?>"> <?= $client['LundiDess1'] ?>  </p></li>
       </ul>
